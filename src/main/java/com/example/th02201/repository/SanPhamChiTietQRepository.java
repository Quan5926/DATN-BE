...
@Repository
public interface SanPhamChiTietQRepository extends JpaRepository<ChiTietSanPham, UUID> {
    /**
     * Lấy danh sách sản phẩm tồn kho thấp (dưới 10 đơn vị).
     * Trả về thông tin tên sản phẩm, số lượng tồn kho, màu sắc, kích cỡ, chất liệu và mã CTSP.
     *
     * @return Danh sách mảng Object, với Object[0] là tenSanPham, Object[1] là soLuongTon,
     * Object[2] là tenMauSac, Object[3] là tenKichCo, Object[4] là tenChatLieu,
     * Object[5] là maCtsp, sắp xếp theo số lượng tồn kho tăng dần.
     */
    @Query("SELECT sp.tenSanPham, spct.soLuongTonKho, ms.tenMauSac, s.tenKichCo, cl.tenChatLieu, spct.maCtsp " +
